...
public class ResponseModel_search {
    ...
    public ResponseModel_search( Integer resultCode, String message, ArrayList<movieModel> movieList) {
        this.resultCode = resultCode;
        this.message = message;
        this.movieList = movieList;
    }
    public ResponseModel_search() {}
