...
public class RequestModel_people_add extends updatePersonModel{
    ...
    public RequestModel_people_add() {}
    @JsonCreator
    public RequestModel_people_add(@JsonProperty(value = "person_id", required = true) Integer person_id,
